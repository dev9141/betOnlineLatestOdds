...
class RegistrationScreenTwo extends StatefulWidget {
  ...
  @override
  StateX<RegistrationScreenTwo> createState() => _RegistrationScreenTwoState();
}

class _RegistrationScreenTwoState extends StateX<RegistrationScreenTwo> {
  User user = User();
  ...
  _RegistrationScreenTwoState() : super(controller: UserController()) {
        ...
        NavigationDelegate(
          ...
          onPageFinished: (url) {
            ...
            if (url.contains("https://api.betonline")) {
              ...
              // Handle form after initial page load
              //Future.delayed(Duration(seconds: 2), () {
                //_handleWebViewForm(formData);
              //});
            ...
            if (url.contains("success_url_identifier")) { // Replace with your success URL identifier
              setState(() {
                _isWebViewLoading = false;
              });
              Navigator.pushReplacement(
...
/*
  String _generateJavaScript(Map<String, String> formData) {
    ...
    formData.forEach((fieldId, value) {
      jsBuffer.writeln('document.getElementById("$fieldId").value = "$value";');
      jsBuffer.writeln('document.getElementById("$fieldId").dispatchEvent(new Event(\'input\'));');
      jsBuffer.writeln('document.getElementById("$fieldId").dispatchEvent(new Event(\'change\'));');
    });
                                            ...
                                            await userController
                                              ...
                                              if (value is APIResponse) {
                                                ...
                                                /*Map<String, String> formData = {
                                                  ...
                                                  "HomePhone": "6042011145",
                                                };

                                                Container(
                                                  height: MediaQuery.of(context).size.height/2,
                                                  child: DynamicUrlWebView(
